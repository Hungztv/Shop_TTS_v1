            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                    ...
                    <p className="text-lg text-white/80 text-center max-w-md">
                        Đăng nhập để truy cập hàng ngàn sản phẩm chất lượng với giá tốt nhất
                    </p>

                    {/* Features */}
                    <div className="mt-12 space-y-4">
                        {['Miễn phí vận chuyển', 'Đổi trả 30 ngày', 'Bảo hành chính hãng'].map((feature, idx) => (
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-8 sm:p-10">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center gap-2 py-3 px-4 border border-gray-200 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
